...
class WanVideoPipeline(BasePipeline):
    ...
    def __init__(self, device="cuda", torch_dtype=torch.bfloat16, tokenizer_path=None):
        ...
        self.scheduler = FlowMatchScheduler(num_inference_steps=1024,shift=5, sigma_min=0.0, extra_one_step=True)
    ...
    def __call__(
        ...
        # Scheduler
        num_inference_steps: Optional[int] = 1000, #Change made here
